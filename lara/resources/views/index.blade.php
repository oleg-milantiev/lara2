...
<div class="container mt-5">
    ...
    @else
        <table class="table table-striped mt-4">
            <thead>
            <tr>
                <th>Дата и время запуска процесса</th>
                <th>Время выполнения, секунд</th>
            ...
            @foreach($processes as $process)
                <tr @if($process->ps_id == 3) class="table-danger" @endif>
                    <td>{{ $process->rp_start_datetime->format('Y.m.d H:i:s') }}</td>
